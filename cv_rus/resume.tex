...
\name{Дугаев}{Роман}
\position{Programmer-developer{\enskip\cdotp\enskip}Hardware-developer}
\address{Russia}

% \mobile{+7 923 172 60 81/+49 1525 2442788}
\mobileprimary{+7 923 172 60 81}
%\mobilesecondary{+49 1525 2442788}
\telegram{t.me/BacyaPetkin}
% \whatsapp{+7 923 172 60 81}
\email{dugaevr@gmail.com}
\dateofbirth{20 Марта, 1995}
%\homepage{www.posquit0.com} 
\github{github.com/BacyaPetkin}
...
\vspace*{\fill}
\centering{\textbf{Детали по запросу}}
%-------------------------------------------------------------------------------
\end{document}
